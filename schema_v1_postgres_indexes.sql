...
/* dbo.inventory — split into two partial uniques (software XOR hardware). */
...
/* dbo.customer_addresses — partial unique on the currently-active row. */
...
/* dbo.transactions — staff + shipping_address FKs (partial). */
